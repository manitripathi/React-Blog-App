...
import { FitContext } from "./FitnessCategory";
import { Link } from "react-router-dom";


const FitnessContext = (props) => {
...
console.warn(props);
  ...
  const FitnessBlogs = useContext(FitContext);

  return (
    
    <div className="Category">
      <div className="bollywood">
        {FitnessBlogs.slice(0, visibleBlogs).map((bollyBogs) => (
